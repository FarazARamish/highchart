...
function showHome() {
    ...
    $('#chart-options').empty();
    $('#content-section').empty();
    $('#chart-options').html('<div class="m-5 text-center"><img class="img-circle" src="https://media.licdn.com/dms/image/C5603AQGXtNX1wwiOeQ/profile-displayphoto-shrink_800_800/0/1631798406098?e=1718236800&v=beta&t=Jl1YHFz13Q8w7-N18tweEjD8MH6Of5KX4FZDQkbYwkc" height="200" width="200" /><h4 class="mt-5">Faraz A Ramish</h4><span>Product Manager | ONDC MSP/ISN Enabler | Entrepreneur | Agile | Digital Transformation | Gen AI</span><h6 class="mt-3"><a href="https://www.linkedin.com/in/farazramish/" target="_blank"><img src="img/linkedin-logo.png" width="96" /></a></h6><h2 class="mt-5">Unlocking Real-Time Data Visualization: A <a href="https://www.highcharts.com/" target="_blank">Highcharts</a> Demo</h2><p>Check out this awesome Highcharts demo I created for real-time data visualization! 📊💻 With just a few lines of code, you can harness the power of Highcharts to display dynamic data in a visually appealing way. Dive into the future of data visualization today!</p><a href="https://gist.github.com/FarazARamish/" target="_blank">Link to my public Gist</a></div>');
}
