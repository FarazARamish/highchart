function lineChartBasic() {
    ...
    chart = Highcharts.chart('chart-demo', {
        title: {
            text: 'U.S Solar Employment Growth - Demo Data',
            align: 'left',
        },
        subtitle: {
            text: 'Basic line chart sample',
            align: 'left',
        },
        yAxis: {
            title: {
    ...
    loadGist('d1b8a632e845533f794f67361b672984');
}

function lineChartBoost() {
    addChartUI();
    ...
    for (i = 0, x = Date.UTC(new Date().getUTCFullYear(), 0, 1) - n * 36e5; i < n; i = i + 1, x = x + 36e5) {
        ...
        data.push([x, 2 * Math.sin(i / 100) + a + b + c + spike + Math.random()]);
    }
    chart = Highcharts.chart('chart-demo', {
        chart: {
            zoomType: 'x',
        ...
        title: {
            text: 'Highcharts drawing ' + n + ' points - Demo Data',
            align: 'left',
        },
        subtitle: {
    ...
    loadGist('3cc9f258c506c7b80d117e9e17ab0e10');
}

function lineChartWithLogarithmicAxis() {
    addChartUI();
    ...
    chart = Highcharts.chart('chart-demo', {
        title: {
            text: 'Logarithmic axis - Demo Data'
        },
        xAxis: {
            tickInterval: 1,
            type: 'logarithmic',
    ...
    loadGist('41f10919c86796c9fde94f98d07f8fb9');
}

function lineChartSplineInverted() {
    addChartUI();
    ...
    chart = Highcharts.chart('chart-demo', {
        ...
        title: {
            text: 'Atmosphere Temperature by Altitude - Demo Data',
            align: 'left'
        },
        subtitle: {
            text: 'Line chart spline inverted sample',
            align: 'left'
        },
        xAxis: {
            reversed: false,
    ...
    loadGist('f71017e4846111882213c33d85598363');
}

function lineChartSplinePlotBand() {
    addChartUI();
    ...
    chart = Highcharts.chart('chart-demo', {
        ...
        title: {
            text: 'Wind speed during a day - Demo Data',
            align: 'left'
        },
        subtitle: {
            text: 'Line chart spline plot band sample',
            align: 'left'
        },
        xAxis: {
            type: 'datetime',
    ...
    loadGist('6b2d31d8c50dd185f937e910aa4c65c0');
}

function lineChartSplineSymboyls() {
    addChartUI();
    ...
    chart = Highcharts.chart('chart-demo', {
        ...
        title: {
            text: 'Monthly Average Temperature - Demo Data'
        },
        subtitle: {
            text: 'Line chart spline symbols sample'
        },
        xAxis: {
    ...
    loadGist('f40baa9d043c2809a0e297a90ffdd853');
}

function lineChartSplineIrregularTimeInterval() {
    addChartUI();
    ...
    chart = Highcharts.chart('chart-demo', {
        ...
        title: {
            text: 'Snow depth at Vikjafjellet, Norway - Demo Data',
            align: 'left'
        },
        subtitle: {
            text: 'Line chart spline irregular time interval sample',
            align: 'left'
        },
        xAxis: {
            type: 'datetime',
    ...
    loadGist('22b0f6a7e9b548350fdfd90b7ac8b592');
}
...
function lineChartTimeSeries() {
    ...
    (async () => {
        ...
        chart = Highcharts.chart('chart-demo', {
            ...
            title: {
                text: 'USD to EUR exchange rate over time - Demo Data',
                align: 'left'
            },
            subtitle: {
                text: document.ontouchstart === undefined ?
    ...
    loadGist('ebf113e6c5efacaad9fb08fee4509e73');
}

function lineChartWithDataLabel() {
    addChartUI();
    ...
    chart = Highcharts.chart('chart-demo', {
        ...
        subtitle: {
            text: 'Line chart with data label sample'
        },
        xAxis: {
    ...
    loadGist('25d74d28ad89919cd8b0134e9645ced5');
}